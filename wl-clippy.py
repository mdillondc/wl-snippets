#!/usr/bin/env python3
# wl-clippy.py - A Wayland-compatible text snippet manager with dark mode and fuzzy search
...
class WlClippy(Gtk.Window):
    def __init__(self, snippets_dir):
        Gtk.Window.__init__(self, title="wl-clippy")
...
def main():
    ...
    snippets_dir = os.path.expanduser("~/Sync/scripts/wl-clippy/snippets/")
